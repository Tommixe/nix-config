{ config, ... }:
{
  services.deluge = {
    ...
    config = {
      ...
      move_completed = true;
      torrentfiles_location = "/srv/multimedia/torrents/files";
      download_location = "/srv/multimedia/torrents/downloading";
      move_completed_path = "/srv/multimedia/torrents/completed";
  ...
  environment.persistence = {
    "/srv/multimedia".directories = [ "/var/lib/deluge" ];
  };
}
